...
<div class="wrapper">
    ...
    <main>
        <table class="table table-bordered table-striped text-center" style="margin: 20px; width: 80%; margin-left: auto; margin-right: auto">
            ...
            <tbody>
            <c:forEach var="station" items="${requestScope.stationsListForAdmin}">
                <tr>
                    <td>${station.ID}</td>
                    ...
                    <td>
                        <div class="d-grid gap-3 d-md-flex justify-content-md-center">
                            ...
                            <c:choose>
                                <c:when test="${station.relevant.equals(true)}">
            ...
            <ul class="pagination justify-content-center">
                ...
                <c:choose>
                    <c:when test="${requestScope.currentPage>1}">
                        <li class="page-item">
                            <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${1}&cityName=${requestScope.cityName}">First</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${requestScope.currentPage>1}">
                        <li class="page-item">
                            <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${requestScope.currentPage-1}&cityName=${requestScope.cityName}">Previous</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                    ...
                    <c:when test="${requestScope.countOfPages<=10}">
                        <c:forEach var="i" begin="1" end="${requestScope.countOfPages}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item">
                                        <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${i}&cityName=${requestScope.cityName}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    ...
                    <c:when test="${requestScope.countOfPages>10}">
                        <c:choose>
                            ...
                            <c:when test="${requestScope.currentPage > 5 && requestScope.currentPage < requestScope.countOfPages-4}">
                                <c:forEach var="i" begin="1" end="5">
                                    <li class="${requestScope.currentPage != i ? 'page-item' : 'page-item active'}">
                                        <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${requestScope.currentPage-5}&cityName=${requestScope.cityName}">...</a>
                                    </li>
                                </c:forEach>
                            </c:when>
                        </c:choose>
                ...
                <c:choose>
                    <c:when test="${requestScope.currentPage<requestScope.countOfPages}">
                        <li class="page-item">
                            <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${requestScope.currentPage+1}&cityName=${requestScope.cityName}">Next</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                ...
                <c:choose>
                    <c:when test="${requestScope.currentPage<requestScope.countOfPages}">
                        <li class="page-item">
                            <a class="page-link" href = "controller?action=allRoutsForAdmin&page=${requestScope.countOfPages}&cityName=${requestScope.cityName}">Last</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
